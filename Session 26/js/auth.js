...
ref.switchButton.addEventListener('click', function () {
    ...
    if (isLoginPage) {
        headerTitleElement.innerText = 'Login' // apare login fiindca am declarat la inceput isLoginPage = !isLoginPage
...
ref.loginButton.addEventListener('click', function (event) {
    event.preventDefault(); // prevenim comportamentul default al butonului/ nu face refresh la [pagina]
